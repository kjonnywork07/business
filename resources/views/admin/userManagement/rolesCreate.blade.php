              ...
              <form method="post" action="{{route('roles-create')}}">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="role_name" placeholder="Role Name" value="{{old('role_name')}}" >
                    @error('role_name')
                  ...
                  <div class="form-group">
                    ...
                    <select name="permissions[]" class="select2" multiple="multiple" data-placeholder="Select Permissions" style="width: 100%;">
                      ...
                      <option value="{{$permission->id}}"  {{!empty(old('permissions'))&& in_array($permission->id,old('permissions'))?'selected':''}} >{{$permission->name}}</option>
                      @endforeach
                    </select>
